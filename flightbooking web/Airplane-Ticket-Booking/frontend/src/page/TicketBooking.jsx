...
const TicketBooking = () => {
  ...
  const handleFlightBooking = async (e) => {
    ...
    try {
      toast.info("Please wait, preparing your booking...");
      ...
      if (data.session && data.session.url) {
        ...
        toast.error(data.message || "Booking failed! Stripe or Backend not configured properly.");
      }
    } catch (error) {
      console.error("Error:", error);
      toast.error("Failed to proceed. Backend or network issue.");
    }
  };
