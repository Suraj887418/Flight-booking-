...
export const getCheckoutSession = async (req, res) => {
  try {
    ...
    if (!stripeKey || stripeKey.includes("<") || stripeKey.trim() === "") {
      // Simulate success if no valid Stripe key is found (Demo Mode)
      session = { url: `${process.env.CLIENT_SITE_URL}payment` };
    } else {
