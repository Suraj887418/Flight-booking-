...
const TicketContainer = ({ ticketData, bookingsData }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row mt-5 print:flex-row print:mt-4 print:border-2 print:border-slate-200 print:rounded-[20px] print:break-inside-avoid" style={{ WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
      <div className="w-[100%] md:w-[60%] flex flex-col justify-between items-center bg-white overflow-hidden rounded-l-[20px] print:w-[60%] print:rounded-none print:rounded-l-[20px]">
        {/* Ticket header */}
        <div className="flex justify-start items-center gap-3 bg-gray-100 py-3 px-5 rounded-t-[20px] w-full">
          <img
            src={ticketData.airlineLogo || "https://upload.wikimedia.org/wikipedia/commons/f/f5/AirAsia_New_Logo.svg"}
            alt="Airline Logo"
      ...
      <div className="border-t-[2px] md:border-l-[2px] border-black border-dashed my-0 mx-[20px] md:mx-0 md:my-[20px] print:border-t-0 print:border-l-[2px]"></div>

      {/* Ticket footer */}
      <div className="w-[100%] md:w-[40%] bg-white rounded-r-[20px] print:w-[40%] print:rounded-none print:rounded-r-[20px]">
